  ...
  return (
    <div className="md:hidden">
      ...
      <nav
        ...
        className={`fixed inset-y-0 right-0 z-50 flex w-72 max-w-[85vw] flex-col gap-1 border-l border-line bg-[#171204] p-5 shadow-2xl transition-transform duration-300 ${
